package io.github.pascalgrimaud.infrastructure.primary.errors;

import io.github.jhipster.config.JHipsterConstants;
import io.github.jhipster.web.util.HeaderUtil;
import io.github.pascalgrimaud.application.UsernameAlreadyUsedException;
import java.net.URI;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        io.github.pascalgrimaud.application.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        io.github.pascalgrimaud.application.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
